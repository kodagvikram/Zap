...
public class ZapsIntentservice extends IntentService {
    ...
    public ZapsIntentservice() {
        super("ZapsIntentservice");
                        ...
                        try {
                            try {
                               ...
                               // if(tempzaparoundlist.size()>0) {
                                    appsingleton.tempzapmelist.clear();
                                    appsingleton.tempzapmelist.addAll(tempzaparoundlist);
                                    Intent broadcastIntent = new Intent();
                                    broadcastIntent.setAction(CheckinZappedMeFragment.MyWebRequestReceiver.PROCESS_RESPONSE);
