...
public class ContactStickyVO implements Serializable {
    ...
    public String gender, age, show_age, userid, user_selfie_thumb,
            place_name, similar_interest_count, similar_interest_name,user_own_selfi,user_own_selfithumb;
    public long id;
    public boolean isselected, islive;
    public ContactStickyVO(long id, String statusmessage, String status, String channel, String username, String lastmessage, String time, String gender, String age
            , String show_age, String userid, String profileurl, String user_selfie_thumb
            , String place_name, String similar_interest_count, String similar_interest_name, String user_own_selfi,String user_own_selfithumb,boolean isselected, boolean islive) {
