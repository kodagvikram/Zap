...
public class CircularimageWhiteBorder extends ImageView {
    private int borderWidth = 17;
    ...
    public CircularimageWhiteBorder(Context context) {
        super(context);
        setup();
    }

    public CircularimageWhiteBorder(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup();
    }
