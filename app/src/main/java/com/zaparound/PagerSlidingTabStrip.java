...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private static final int[] ANDROID_ATTRS = new int[]{
            android.R.attr.textColorPrimary, android.R.attr.padding,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDividerWidth > 0) {
            ...
            for (int i = 0; i < mTabCount; i++) {
                ...
                canvas.drawLine(tab.getLeft(), mDividerPadding, tab.getLeft(), height - mDividerPadding, mDividerPaint);
            }
        }
        ...
        if (mUnderlineHeight > 0) {
            ...
            canvas.drawRect(mPaddingLeft, height - mUnderlineHeight,
                    mTabsContainer.getWidth() + mPaddingRight, height, mRectPaint);
        }
    ...
    public void setOnTabReselectedListener(
            OnTabReselectedListener tabReselectedListener) {
    ...
    private ColorStateList createColorStateList(int color_state_pressed,
                                                int color_state_selected, int color_state_default) {
