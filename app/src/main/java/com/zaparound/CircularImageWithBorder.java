...
public class CircularImageWithBorder extends ImageView {
    ...
    public CircularImageWithBorder(Context context) {
        super(context);
        setup();
    }

    public CircularImageWithBorder(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup();
    }
