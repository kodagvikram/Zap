...
public class UserMyChatCircularLogoPicture extends ImageView {
    ...
    public UserMyChatCircularLogoPicture(Context context) {
        super(context);
        setup();
    }

    public UserMyChatCircularLogoPicture(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup();
    }
    ...
    private void setup() {
        ...
        paintBorder.setShadowLayer(0.0f, 0.0f, 2.0f, Color.WHITE);
    }
